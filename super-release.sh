...
if [ $STOP -eq 0 ]; then
        ...
        git commit -am "releasing josso-multiidentitystore-$CLOSE_VERSION"
        git tag josso-multiidentitystore-$CLOSE_VERSION
        git push origin josso-multiidentitystore-$CLOSE_VERSION
        ...
        git commit -am "setting next version to releasing josso-multiidentitystore-$CLOSE_VERSION"
        git push
